...
public final class OooO0OO implements IVolumeAdjustment {
    ...
    public void volumeDown(int i) {
        ...
        if (i == 1) {
            ...
            OooO00o.OooO0O0.OooO0O0.OooO0o0.OooO0o0.OooO00o<Integer> o000000O = oooO0o.o000000O();
            if (intValue >= 0) {
                i2 = Integer.valueOf(intValue);
            } else {
                i2 = 0;
            }
            o000000O.OooO00o((OooO00o.OooO0O0.OooO0O0.OooO0o0.OooO0o0.OooO00o<Integer>) i2);
        } else if (i == 2) {
            Intrinsics.checkNotNullParameter("AdjustByKO", Progress.TAG);
            ...
            OooO00o.OooO0O0.OooO0O0.OooO0o0.OooO0o0.OooO00o<Integer> OooO0O0 = oooO0o2.OooO0O0();
            if (intValue2 >= 0) {
            ...
            OooO00o.OooO0O0.OooO0O0.OooO0o0.OooO0o0.OooO00o<Integer> Ooooo0o = oooO0o3.Ooooo0o();
            if (intValue3 >= 0) {
                i4 = Integer.valueOf(intValue3);
            } else {
                i4 = 0;
            }
            Ooooo0o.OooO00o((OooO00o.OooO0O0.OooO0O0.OooO0o0.OooO0o0.OooO00o<Integer>) i4);
        } else if (i != 4) {
        } else {
            Intrinsics.checkNotNullParameter("AdjustByKO", Progress.TAG);
            Intrinsics.checkNotNullParameter("  laBaMicCompanyVolumeDown", NotificationCompat.CATEGORY_MESSAGE);
            if (OooO00o.OooO0O0.OooO0O0.OooO0O0.OooO0O0 <= 3) {
                Log.i("LogTuning", "AdjustByKO ->   laBaMicCompanyVolumeDown");
            }
            OooOO0 oooOO0 = OooOO0.f398OooO00o;
            if (oooOO0.o0000OOo().OooO00o() == null) {
                return;
            }
            Integer OooO00o5 = oooOO0.o0000OOo().OooO00o();
    ...
    public void volumeUp(int i) {
        ...
        if (i == 1) {
            ...
            if (OooO00o.OooO0O0.OooO0O0.OooO0O0.OooO0O0 <= 3) {
                Log.i("LogTuning", "AdjustByKO ->   laBaMicCompanyVolumeUp");
            }
            OooOO0 oooOO0 = OooOO0.f398OooO00o;
            if (oooOO0.o0000OOo().OooO00o() == null) {
                return;
