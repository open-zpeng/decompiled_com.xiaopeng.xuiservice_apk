...
public class Imgproc {
    ...
    public static void putText(Mat img, String text, Point org2, int fontFace, double fontScale, Scalar color, int thickness, int lineType) {
        putText_1(img.nativeObj, text, org2.x, org2.y, fontFace, fontScale, color.val[0], color.val[1], color.val[2], color.val[3], thickness, lineType);
    }

    public static void putText(Mat img, String text, Point org2, int fontFace, double fontScale, Scalar color, int thickness) {
        putText_2(img.nativeObj, text, org2.x, org2.y, fontFace, fontScale, color.val[0], color.val[1], color.val[2], color.val[3], thickness);
    }

    public static void putText(Mat img, String text, Point org2, int fontFace, double fontScale, Scalar color) {
        putText_3(img.nativeObj, text, org2.x, org2.y, fontFace, fontScale, color.val[0], color.val[1], color.val[2], color.val[3]);
    }
