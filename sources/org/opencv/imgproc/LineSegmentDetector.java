...
public class LineSegmentDetector extends Algorithm {
    ...
    public void detect(Mat _image, Mat _lines, Mat width, Mat prec) {
        detect_1(this.nativeObj, _image.nativeObj, _lines.nativeObj, width.nativeObj, prec.nativeObj);
    }

    public void detect(Mat _image, Mat _lines, Mat width) {
        detect_2(this.nativeObj, _image.nativeObj, _lines.nativeObj, width.nativeObj);
    }

    public void detect(Mat _image, Mat _lines) {
        detect_3(this.nativeObj, _image.nativeObj, _lines.nativeObj);
    }
