...
public interface IRMDownloadCallback extends IInterface {
    ...
    void onDownloadCallback(int type, ResourceDownloadInfo resourceDownloadInfo) throws RemoteException;

    void onMenuOpenCallback(String resId) throws RemoteException;
