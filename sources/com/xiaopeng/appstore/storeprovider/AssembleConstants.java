...
public class AssembleConstants {
    ...
    public static final String EXTRA_KEY_PARAMS_DOWNLOAD_LIST_OPEN_ACTION = "extra_key_params_download_list_open_action";
    public static final String EXTRA_KEY_PARAMS_FILE_PATH = "extra_key_params_file_path";
    public static final String EXTRA_KEY_PARAMS_FILE_PATH_OUT = "extra_key_params_file_path_out";
