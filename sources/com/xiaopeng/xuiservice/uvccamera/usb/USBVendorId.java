...
public class USBVendorId {
    ...
    static {
        IDS.put(Videoio.CAP_PROP_GIGA_FRAME_SENS_HEIGH, "YUEN DA ELECTRONIC PRODUCTS FACTORY");
        ...
        IDS.put(StorageException.REASON_EXCEED_TASK_LIMITATION, "ALi Corporation");
        ...
        IDS.put(ResponseParams.RESPONSE_CODE_ERROR_PRELOAD_APP_FAILED, "Microchip-SMSC");
        ...
        IDS.put(Videoio.CAP_PROP_INTELPERC_PROFILE_COUNT, "Drapho Electronics Technology Co., Ltd.");
        ...
        IDS.put(Videoio.CAP_AVFOUNDATION, "Nikon Corporation");
        ...
        IDS.put(StorageException.REASON_DOWNLOAD_ERROR, "Fujikura/DDK");
        IDS.put(StorageException.REASON_DOWNLOAD_INCOMPLETE, "Acer, Inc.");
        IDS.put(1287, "Hosiden Corporation");
        IDS.put(1293, "Belkin International, Inc.");
        IDS.put(Videoio.CAP_GIGANETIX, "FCI Electronics");
        ...
        IDS.put(Videoio.CAP_WINRT, "Roland Corporation");
        ...
        IDS.put(IAppResourceException.REASON_HTTP_NO_ETAG, "Chief Land Electronic Co., Ltd.");
        ...
        IDS.put(HttpInitEventListener.CODE_FAILED_INIT_XMART_KEYSTORE, "Shenzhen Alex Connector Co., Ltd.");
        IDS.put(HttpInitEventListener.CODE_FAILED_INIT_DEFAULT_KEYSTORE, "System Level Solutions, Inc.");
