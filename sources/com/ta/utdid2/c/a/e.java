...
class e {
    public static final void a(Map map, OutputStream outputStream) throws XmlPullParserException, IOException {
        a aVar = new a();
        aVar.setOutput(outputStream, JsonRequest.PROTOCOL_CHARSET);
    ...
    public static final HashMap m108a(XmlPullParser xmlPullParser, String str, String[] strArr) throws XmlPullParserException, IOException {
    ...
    /* renamed from: a  reason: collision with other method in class */
    public static final int[] m109a(XmlPullParser xmlPullParser, String str, String[] strArr) throws XmlPullParserException, IOException {
        try {
    ...
    private static final Object b(XmlPullParser xmlPullParser, String[] strArr) throws XmlPullParserException, IOException {
        ...
        if (!name.equals("null")) {
            if (name.equals("string")) {
                ...
                xmlPullParser.next();
                int[] m109a = m109a(xmlPullParser, "int-array", strArr);
                strArr[0] = attributeValue;
                return m109a;
            } else if (name.equals("map")) {
                xmlPullParser.next();
                HashMap m108a = m108a(xmlPullParser, "map", strArr);
                strArr[0] = attributeValue;
                return m108a;
