package com.loostone.libtuning.channel.oppo;
...
import com.loostone.libtuning.component.provider.TuningProvider;
...
public final class OPPOAMgr extends BaseChannelMgr implements OooO0O0, IKeyListener, OooOO0O<Boolean> {
    ...
    */
    public OPPOAMgr(android.content.Context r1, int r2, kotlin.jvm.internal.DefaultConstructorMarker r3) {
        /*
            r0 = this;
            r2 = r2 & 1
            if (r2 == 0) goto L10
        ...
        L10:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.loostone.libtuning.channel.oppo.OPPOAMgr.<init>(android.content.Context, int, kotlin.jvm.internal.DefaultConstructorMarker):void");
    }
    ...
    public void onDeviceAddedWithHid(@NotNull OooO00o cachedDevice) {
        ...
        if (context != null) {
            Toast.makeText(context, R.string.oppo_a_mic_in, 0).show();
    ...
    public void onVoice(int i, boolean z) {
        ...
        if (z) {
            ...
            intent.setComponent(new ComponentName("com.heytap.speechassist.tv", "com.heytap.speechassist.tv.core.SpeechService"));
            intent.putExtra("caller_package", TuningProvider.AUTHORITY);
            intent.putExtra("start_type", 536870912);
    ...
    public OPPOAMgr(@NotNull Context context) {
        super(context);
